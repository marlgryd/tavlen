...
draw.line((0, 240, 600, 240), fill=(0), width=(5))
draw.line((600, 240, 600, 480), fill=(0), width=(5))
draw.line((400, 120, 800, 120), fill=(0), width=(5))
draw.line((400, 0, 400, 240), fill=(0), width=(5))
draw.line((600, 360, 800, 360), fill=(0), width=(5))
...
draw.text((200+20, 50),'Her kan det stå masse\n\n Huskeliste\n - jobbe\n - spise\n - sove',(0),font=font2)
...
im.save('pillow_imagedraw5.bmp', quality=95)
